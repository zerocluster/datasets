...
CREATE INDEX geotarget_name_nocase_idx ON geotarget ( name COLLATE NOCASE );
CREATE INDEX geotarget_canonical_name_nocase_idx ON geotarget ( canonical_name COLLATE NOCASE );
