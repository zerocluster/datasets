...
import { countriesGeoJson } from "#lib/exteernal-resources";

countriesGeoJson.on( "update", resource => buildTree() );
...
function buildTree () {
    const json = readConfig( countriesGeoJson.location + "/countries.geo.json" );
