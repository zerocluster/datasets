...
const CONST = {
    ...
    "index": {
        ...
        "google-geotargets": {
            ...
            "location": url.pathToFileURL( location + "/google-geotargets.sqlite" ),
        },
        "countries-geojson": {
            "name": "countries-geojson.sqlite",
            "path": location + "/countries-geojson.sqlite",
            "location": url.pathToFileURL( location + "/countries-geojson.sqlite" ),
        },
        "countries-triangles": {
            "name": "countries-triangles.sqlite",
            "path": location + "/countries-triangles.sqlite",
            "location": url.pathToFileURL( location + "/countries-triangles.sqlite" ),
        },
    },
};
