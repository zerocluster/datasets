const CONST = {
    ...
    "path": process.platform === "win32" ? process.env.LOCALAPPDATA + "/databases" : "/var/lib/databases",
...
CONST.db = "sqlite://" + CONST.path + "/data.sqlite";
CONST.dbLocal = "sqlite://" + CONST.path + "/data-local.sqlite";
