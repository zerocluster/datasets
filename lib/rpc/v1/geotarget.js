...
export default class extends Base() {
    ...
    /** method: API_get_geojson
     * summary: Get GEOTarget geojson by id or canonical name.
     * params:
     *   - name: id
     *     required: true
     *     schema:
     *       type: [number, string]
     */
    async API_get_geojson ( auth, id ) {
        var geotarget = await auth.call( "geotarget/get", id );
