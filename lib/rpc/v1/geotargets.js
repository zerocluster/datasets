...
export default class extends Base {
    ...
    async API_get ( ctx, id ) {
        ...
        res = await dbhGoogleGeotargets.selectRow( QUERIES.get, [id, id] );
    ...
    async API_get_geojson ( ctx, id ) {
        ...
        var res = await dbhCache.selectRow( QUERIES.get_geojson, [geotarget.id] );
        ...
        await dbhCache.do( QUERIES.insert_geojson, [id, geojson, geojson] );
