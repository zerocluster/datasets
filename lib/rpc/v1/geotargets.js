...
export default class extends Base {
    ...
    async API_get_geojson ( ctx, id ) {
        ...
        var res = await ( await this.app.dbh( "local" ) ).selectRow( QUERIES.get_geojson, [geotarget.id] );
        ...
        await ( await this.app.dbh( "local" ) ).do( QUERIES.insert_geojson, [id, geojson, geojson] );
