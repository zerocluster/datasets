...
const QUERIES = {
    "get": sql`SELECT * FROM geotarget WHERE id = ? OR canonical_name LIKE ? OR ( type = 'country' AND country = ? )`.prepare(),
...
export default class extends Base {
    ...
    async API_get ( ctx, id ) {
        ...
        res = dbhGoogleGeotargets.selectRow( QUERIES.get, [id, id, id] );
