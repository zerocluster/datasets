...
function getTriangle ( country_iso2 ) {
    const probability = Math.random();

    const coords = dbh.selectRow( q, [country_iso2, probability] );
...
export default function getCountryRandomCoordinates ( country_iso2 ) {
    const triangle = getTriangle( country_iso2 );
