...
export default class Build {
    ...
    async build ( id ) {
        ...
        // not modified
        if ( ( remoteIndex[id]?.hash && remoteIndex[id]?.hash === updated.data.hash ) || ( remoteIndex[id]?.lastModified && remoteIndex[id]?.hash === updated.data.lastModified ) ) return result( 304 );
